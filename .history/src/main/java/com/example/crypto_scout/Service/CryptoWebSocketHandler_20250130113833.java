...
public class CryptoWebSocketHandler extends TextWebSocketHandler {
    ...
    private static final double PRICE_CHANGE_THRESHOLD = 10.0; //Only update if price changes by 5%
    private static final int UPDATE_INTERVAL = 300; // Send updates every 60 seconds

...
public class CryptoWebSocketHandler extends TextWebSocketHandler {
    ...
    private void startBatchProcessor() {
        scheduler.scheduleAtFixedRate(() -> {
            ...
            System.out.println("📊 Buffer Size Before Processing: " + messageBuffer.size());
            ...
            if (!messageBuffer.isEmpty()) {
                try {
                    ...
                    while (!messageBuffer.isEmpty()) {
                        ...
                        System.out.println("🗑️ Processing message: " + updateStr); // ✅ Log each message before removal
                    ...
                    if (!batchedUpdates.isEmpty()) {
                        ...
                        // ✅ Log before sending to WebSocket clients
                        System.out.println("📡 Sending WebSocket Message to /topic/crypto");
        ...
        }, 5, 10, TimeUnit.SECONDS); // ✅ 5s delay to allow messages to accumulate
    }

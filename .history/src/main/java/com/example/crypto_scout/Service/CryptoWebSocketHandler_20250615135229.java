...
public class CryptoWebSocketHandler extends TextWebSocketHandler {
    ...
    public static class CryptoWebSocketInitException extends Exception {
        public CryptoWebSocketInitException(String message, Throwable cause) {
            super(message, cause);
        }
    }
    ...
    public void init() throws CryptoWebSocketInitException {
        try {
            ...
            throw new CryptoWebSocketInitException("Failed to initialize Coinbase WebSocket", e);
        }
    }

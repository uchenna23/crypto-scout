...
public class CryptoWebSocketHandler extends TextWebSocketHandler {
    ...
    private void startBatchProcessor() {
        scheduler.scheduleAtFixedRate(() -> {
            ...
            System.out.println("📊 Buffer Size Before Processing: " + messageBuffer.size()); // ✅ Log buffer size before processing
        ...
        }, 5, 10, TimeUnit.SECONDS); // ✅ Delay first execution to ensure buffer fills
    }

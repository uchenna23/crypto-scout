    ...
    this.chartOptions = {
      ...
      plugins: {
        ...
        zoom: {
          ...
          zoom: {
            ...
            mode: 'xy',
            limits: {
              x: { min: 0, max: 20 },       // ✅ Limit for x-axis zoom
              y: { min: 0, max: 500000 }    // ✅ Limit zoom between $0 and $500,000
            }
          }
        }
      },
      scales: {
        ...
        y: {
          ...
          ticks: {
            stepSize: 10000,              // ✅ Show ticks every $10,000 for better clarity
            autoSkip: false
          },
          min: 0,                         // ✅ Start y-axis from $0
          max: 500000                     // ✅ Max y-axis value set to $500,000
        }
      }
    };
  }

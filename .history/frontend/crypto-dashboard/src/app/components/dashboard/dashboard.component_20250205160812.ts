...
export class DashboardComponent implements OnInit {
  ...
  resetZoom(): void {
    if (this.cryptoChart) {
      const chartInstance = Chart.getChart(this.cryptoChart.nativeElement); // ✅ Get Chart.js instance
      if (chartInstance) {
        chartInstance.resetZoom();
        console.log('🔄 Zoom reset successful.');
      } else {
        console.warn('⚠️ No chart instance found.');
      }
    }
  }
